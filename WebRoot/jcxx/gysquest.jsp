  ...
  <style type="text/css">
	...
	<body>
		<blockquote class="layui-elem-quote" style="margin-bottom:0px">
			<span  class="word_deepgrey"> 当前位置：基础信息管理 ></span>供应商信息查询&gt;&gt;&gt;
		</blockquote>
		    
	   <form name="form1" method="POST" action="search/gysquest_dosearch.jsp" target="main2Frame" id="form1">
