  ...
  <style type="text/css">
	...
	<body>
		<blockquote class="layui-elem-quote" style="margin-bottom:0px">
			<span  class="word_deepgrey"> 当前位置：基础信息管理 ></span>客户信息查询&gt;&gt;&gt;
		</blockquote>
		    
	   <form name="form1" method="POST" action="search/khquest_dosearch.jsp" target="main2Frame" id="form1">
	    
	      <div class="layui-input-inline">   
			      
			   		 <select name="cif" class="form-control"style="width:120">
				        <option value="" disabled>查询方式</option>
				        <option value="khqc" selected="">客户全称</option>
