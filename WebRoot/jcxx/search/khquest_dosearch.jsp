...
<%
   ...
   String httpFile="khquest_dosearch.jsp";//设置处理请求的JSP文件
...
function DeleteData(input){
    ...
    var DeleteSql = "delete  from tb_customer where ID = '"+dataid+"'";
    showcheck(DeleteSql);
