...
<%
   ...
   String table="tb_supplier";//设置所要查询的表名；
   String httpFile="gysquest_dosearch.jsp";//设置处理请求的JSP文件
...
<table style="width:97% ;margin-left:10;border-width:2;border-color:#666"  class="table table-bordered" >
  <tr>
    <td width="202" height="27" bgcolor="#E9F2F6">供应商全称:
  ...
  <tr>
    <td width="202" height="27" bgcolor="#E9F2F6">联系人:
      <%=rs.getString("lxr")%></td>
  ...
  <tr>
    <td colspan="3" bgcolor="#E9F2F6">E-Mail:
      <%=rs.getString("email")%></td>
  </tr>
   <tr>
  	<td width="202" height="26" bgcolor="#E9F2F6">供应商编号:
      <%=rs.getString("ID")%></td>
    <td bgcolor="#E9F2F6">
      </td>
...
function DeleteData(input){
    ...
    var DeleteSql = "delete  from tb_supplier where ID = '"+dataid+"'";
    showcheck(DeleteSql);
